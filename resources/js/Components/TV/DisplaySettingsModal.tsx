        ...
        >
          ...
          >
            ...
            <div className="space-y-[2vh]">
              {sliders.map((s) => (
                <div key={s.type} className="p-[1.2vw] rounded-2xl display-focusable focus:ring-2 focus:ring-[#d4af37] focus:ring-offset-2 focus:ring-offset-slate-900"
                ...
                >
                  <div className="flex items-center justify-between mb-[1vh]">
                    ...
                    <span className="text-[#d4af37] text-[0.8vw] font-bold">{Math.round(s.value * 100)}%</span>
                  </div>
            ...
            <div className="mt-[3vh] flex flex-col gap-[1vh] items-center">
              <button
                onClick={handleApply}
                className="w-full py-[1.2vh] rounded-xl bg-[#d4af37] hover:bg-[#d4af37] text-white font-bold text-[1vw] transition-colors display-focusable focus:ring-4 focus:ring-[#d4af37]/30 mb-[1vh]"
                tabIndex={0}
              >
                Apply Settings
              </button>
