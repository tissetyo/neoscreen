        ...
        >
          ...
          {status === 'success' ? (
             <div className="text-center py-[2vw]">
                <div className="w-[4vw] h-[4vw] mx-auto rounded-full bg-[#d4af37]/20 text-[#d4af37] flex items-center justify-center mb-4 border border-[#d4af37]/50">
            ...
            <div className="grid grid-cols-2 gap-[1.5vw]">
               <button 
                 ...
                 className="bg-white/10 hover:bg-[#d4af37] hover:border-[#d4af37] border border-white/20 p-[2vw] rounded-2xl flex flex-col items-center text-center transition-all checkout-btn tv-focusable group"
                 tabIndex={0}
               >
                  ...
                  <span className="text-[0.8vw] text-slate-400 group-hover:text-[#f3e5ab] mt-2">Extend by a few hours. Subject to availability and a small fee.</span>
               </button>
