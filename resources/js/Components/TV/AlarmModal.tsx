              ...
              <div className="p-6">
                  ...
                  <div className="flex flex-col gap-2">
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg text-lg font-semibold transition-colors alarm-focusable ${
                        amPm === 'AM' ? 'bg-[#d4af37] text-white' : 'bg-white/10 text-white/50'
                      }`}
                      tabIndex={0}
                    >
                      AM
                    ...
                    <button
                      onClick={() => setAmPm('PM')}
                      className={`px-4 py-2 rounded-lg text-lg font-semibold transition-colors alarm-focusable ${
                        amPm === 'PM' ? 'bg-[#d4af37] text-white' : 'bg-white/10 text-white/50'
                      }`}
                      tabIndex={0}
                    >
                      PM
                ...
                <div className="mt-4">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-white placeholder-white/30 focus:border-[#d4af37] focus:outline-none"
                  />
                </div>
